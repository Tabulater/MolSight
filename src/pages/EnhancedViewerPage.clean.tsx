  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top toolbar */}
        <div className="bg-slate-900/80 backdrop-blur-md border-b border-slate-800/50 p-2 flex items-center justify-between">
        ...
        <div className="flex-1 overflow-hidden relative">
          ...
          <div className="absolute top-4 right-4 bg-slate-900/80 backdrop-blur-md rounded-xl p-2 flex flex-col space-y-2 border border-slate-800/50">
            <ToolButton
              icon={Move3D}
              label="Select"
          ...
          {measurements.length > 0 && (
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-slate-900/80 backdrop-blur-md rounded-lg p-3 max-w-md w-full border border-slate-800/50">
              ...
              <div className="space-y-1 max-h-40 overflow-y-auto">
                {measurements.map((m) => (
                  <div 
                    key={m.id} 
                    className="flex justify-between items-center p-2 rounded hover:bg-slate-800/50"
                  >
